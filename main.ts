...
statusbars.onStatusReached(StatusBarKind.Energy, statusbars.StatusComparison.EQ, statusbars.ComparisonType.Fixed, 4, function (status) {
    light.setAll(0x000000)
    light.setPixelColor(0, 0xff00ff)
    light.setPixelColor(1, 0xff00ff)
...
statusbars.onStatusReached(StatusBarKind.Energy, statusbars.StatusComparison.EQ, statusbars.ComparisonType.Fixed, 1, function (status) {
    light.setAll(0x000000)
    light.setPixelColor(0, 0xff00ff)
})
...
statusbars.onStatusReached(StatusBarKind.Energy, statusbars.StatusComparison.EQ, statusbars.ComparisonType.Fixed, 0, function (status) {
    light.setAll(0x000000)
})
statusbars.onStatusReached(StatusBarKind.Energy, statusbars.StatusComparison.EQ, statusbars.ComparisonType.Fixed, 3, function (status) {
    light.setAll(0x000000)
    light.setPixelColor(0, 0xff00ff)
    light.setPixelColor(1, 0xff00ff)
    light.setPixelColor(2, 0xff00ff)
